        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16">
          ...
          <div className="w-full lg:w-1/2 space-y-6">
            <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">
              We deliver the <span className="text-indigo-600">best work</span>{" "}
              you dream of!
            </h3>
            <p className="text-lg text-gray-600 leading-relaxed">
              We are a one-stop design & build firm offering a complete range of
              luxury real estate, architecture, and construction services in LA.
              Our team is committed to turning your vision into reality with
